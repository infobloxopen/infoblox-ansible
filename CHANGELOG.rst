...
- Supports camelCase while updating 'nios_network_view' with 'new_name'
- Supports to allocate ip to a_record dynamically
...
- Fix to support camelcase for updating 'nios_network_view' name `#163 <https://github.com/infobloxopen/infoblox-ansible/pull/163>`_
